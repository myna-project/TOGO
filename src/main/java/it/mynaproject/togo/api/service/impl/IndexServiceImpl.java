...
public class IndexServiceImpl implements IndexService {
	...
	private List<Measure> getIndexResults(Index index, Date start_time, Date end_time, TimeAggregation aggregation, Boolean isAdmin, String username) {
		...
		for (IndexComponent ic : index.getComponents()) {
			...
			List<PairDrainMeasuresJson> measuresJson = this.measureService.getMeasures(drainIds, drainOperations, measureAggregations, null, null, start_time, end_time, aggregation, false, isAdmin, username);
