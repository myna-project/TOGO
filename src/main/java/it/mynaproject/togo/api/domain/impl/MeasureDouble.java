...
@Entity
@Table(name="measure_double")
public class MeasureDouble implements Measure<Double>, Serializable {

	private static final long serialVersionUID = -3735834985099450809L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MeasureDouble other = (MeasureDouble) obj;
		if (drain == null) {
			if (other.drain != null)
				return false;
